...
function Welcome() {
    ...
    return (
        <div className='flex px-10 md:px-20'>
            <div className='mt-14 md:pt-36 text-center tracking-wider md:w-1/2'>
                ...
                <div className='mt-10 md:mt-10 flex justify-center gap-12 text-2xl font-bold'>
                    <Link to='/login' className='shadow-xl px-3 py-1 text-base md:text-3xl md:px-5 md:py-2 rounded-xl border'>Login</Link>
                    <Link to='/login' className='bg-secondary-color shadow-xl px-3 py-1 text-base md:text-3xl md:px-5 md:py-2 rounded-xl text-white'>Get Started</Link>
                </div>
            </div>
